...
public class BillingAccountRef {
  ...
  public BillingAccountRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public BillingAccountRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BillingAccountRef atBaseType(@Nullable String atBaseType) {
  ...
  public BillingAccountRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public BillingAccountRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public BillingAccountRef atReferredType(@Nullable String atReferredType) {
