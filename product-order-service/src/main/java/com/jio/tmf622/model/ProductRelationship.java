...
public class ProductRelationship {
  ...
  public ProductRelationship atBaseType(@Nullable String atBaseType) {
  ...
  public ProductRelationship atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductRelationship atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
