...
public class ProductOfferingQualificationRef {
  ...
  public ProductOfferingQualificationRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingQualificationRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOfferingQualificationRef atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingQualificationRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOfferingQualificationRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductOfferingQualificationRef atReferredType(@Nullable String atReferredType) {
