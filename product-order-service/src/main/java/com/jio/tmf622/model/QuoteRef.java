...
public class QuoteRef {
  ...
  public QuoteRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public QuoteRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public QuoteRef atBaseType(@Nullable String atBaseType) {
  ...
  public QuoteRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public QuoteRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public QuoteRef atReferredType(@Nullable String atReferredType) {
