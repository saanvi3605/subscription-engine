...
import com.jio.tmf622.model.ProductOrderAttributeValueChangeEventPayload;
...
public class ProductOrderAttributeValueChangeEvent {
  ...
  private @Nullable ProductOrderAttributeValueChangeEventPayload event;

  public ProductOrderAttributeValueChangeEvent eventId(@Nullable String eventId) {
  ...
  public ProductOrderAttributeValueChangeEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOrderAttributeValueChangeEvent eventType(@Nullable String eventType) {
  ...
  public ProductOrderAttributeValueChangeEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOrderAttributeValueChangeEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOrderAttributeValueChangeEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOrderAttributeValueChangeEvent description(@Nullable String description) {
  ...
  public ProductOrderAttributeValueChangeEvent priority(@Nullable String priority) {
  ...
  public ProductOrderAttributeValueChangeEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOrderAttributeValueChangeEvent fieldPath(@Nullable String fieldPath) {
  ...
  public ProductOrderAttributeValueChangeEvent event(@Nullable ProductOrderAttributeValueChangeEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOrderAttributeValueChangeEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOrderAttributeValueChangeEventPayload event) {
    this.event = event;
  }
