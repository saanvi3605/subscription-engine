...
public class ProductOrderRef {
  ...
  public ProductOrderRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOrderRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOrderRef atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOrderRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOrderRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductOrderRef atReferredType(@Nullable String atReferredType) {
