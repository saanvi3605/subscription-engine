...
public class PaymentRef {
  ...
  public PaymentRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public PaymentRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PaymentRef atBaseType(@Nullable String atBaseType) {
  ...
  public PaymentRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public PaymentRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PaymentRef atReferredType(@Nullable String atReferredType) {
