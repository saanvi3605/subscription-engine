...
public class ProductOfferingRef {
  ...
  public ProductOfferingRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOfferingRef atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOfferingRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductOfferingRef atReferredType(@Nullable String atReferredType) {
