...
import com.jio.tmf622.model.ProductOrderInformationRequiredEventPayload;
...
public class ProductOrderInformationRequiredEvent {
  ...
  private @Nullable ProductOrderInformationRequiredEventPayload event;

  public ProductOrderInformationRequiredEvent eventId(@Nullable String eventId) {
  ...
  public ProductOrderInformationRequiredEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public ProductOrderInformationRequiredEvent eventType(@Nullable String eventType) {
  ...
  public ProductOrderInformationRequiredEvent correlationId(@Nullable String correlationId) {
  ...
  public ProductOrderInformationRequiredEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ProductOrderInformationRequiredEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProductOrderInformationRequiredEvent description(@Nullable String description) {
  ...
  public ProductOrderInformationRequiredEvent priority(@Nullable String priority) {
  ...
  public ProductOrderInformationRequiredEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public ProductOrderInformationRequiredEvent fieldPath(@Nullable String fieldPath) {
  ...
  public ProductOrderInformationRequiredEvent event(@Nullable ProductOrderInformationRequiredEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable ProductOrderInformationRequiredEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable ProductOrderInformationRequiredEventPayload event) {
    this.event = event;
  }
