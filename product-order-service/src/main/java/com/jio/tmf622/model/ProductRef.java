...
public class ProductRef {
  ...
  public ProductRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductRef atBaseType(@Nullable String atBaseType) {
  ...
  public ProductRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductRef atReferredType(@Nullable String atReferredType) {
