...
public class ProductOfferingPriceRef {
  ...
  public ProductOfferingPriceRef href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public ProductOfferingPriceRef name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductOfferingPriceRef atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOfferingPriceRef atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOfferingPriceRef atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public ProductOfferingPriceRef atReferredType(@Nullable String atReferredType) {
