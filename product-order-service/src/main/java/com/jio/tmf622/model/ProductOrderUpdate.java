...
public class ProductOrderUpdate {
  ...
  public ProductOrderUpdate cancellationDate(@Nullable OffsetDateTime cancellationDate) {
  ...
  public ProductOrderUpdate cancellationReason(@Nullable String cancellationReason) {
  ...
  public ProductOrderUpdate category(@Nullable String category) {
  ...
  public ProductOrderUpdate completionDate(@Nullable OffsetDateTime completionDate) {
  ...
  public ProductOrderUpdate description(@Nullable String description) {
  ...
  public ProductOrderUpdate expectedCompletionDate(@Nullable OffsetDateTime expectedCompletionDate) {
  ...
  public ProductOrderUpdate externalId(@Nullable String externalId) {
  ...
  public ProductOrderUpdate notificationContact(@Nullable String notificationContact) {
  ...
  public ProductOrderUpdate priority(@Nullable String priority) {
  ...
  public ProductOrderUpdate requestedCompletionDate(@Nullable OffsetDateTime requestedCompletionDate) {
  ...
  public ProductOrderUpdate requestedStartDate(@Nullable OffsetDateTime requestedStartDate) {
  ...
  public ProductOrderUpdate billingAccount(@Nullable BillingAccountRef billingAccount) {
  ...
  public ProductOrderUpdate state(@Nullable ProductOrderStateType state) {
    this.state = state;
    return this;
  }
  ...
  public ProductOrderUpdate atBaseType(@Nullable String atBaseType) {
  ...
  public ProductOrderUpdate atSchemaLocation(@Nullable URI atSchemaLocation) {
  ...
  public ProductOrderUpdate atType(@Nullable String atType) {
    this.atType = atType;
    return this;
  }
