...
import com.jio.tmf622.model.CancelProductOrderCreateEventPayload;
...
public class CancelProductOrderCreateEvent {
  ...
  private @Nullable CancelProductOrderCreateEventPayload event;

  public CancelProductOrderCreateEvent id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent href(@Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent eventId(@Nullable String eventId) {
  ...
  public CancelProductOrderCreateEvent eventTime(@Nullable OffsetDateTime eventTime) {
  ...
  public CancelProductOrderCreateEvent eventType(@Nullable String eventType) {
  ...
  public CancelProductOrderCreateEvent correlationId(@Nullable String correlationId) {
  ...
  public CancelProductOrderCreateEvent domain(@Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CancelProductOrderCreateEvent description(@Nullable String description) {
  ...
  public CancelProductOrderCreateEvent priority(@Nullable String priority) {
  ...
  public CancelProductOrderCreateEvent timeOcurred(@Nullable OffsetDateTime timeOcurred) {
  ...
  public CancelProductOrderCreateEvent event(@Nullable CancelProductOrderCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  public @Nullable CancelProductOrderCreateEventPayload getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(@Nullable CancelProductOrderCreateEventPayload event) {
    this.event = event;
  }
